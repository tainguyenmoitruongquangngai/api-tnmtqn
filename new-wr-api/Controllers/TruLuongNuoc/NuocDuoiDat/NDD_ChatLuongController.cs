...
namespace new_wr_api.Controllers
{
    ...
    public class NDD_ChatLuongController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("danh-sach")]
        public async Task<List<TLN_NuocDuoiDat_ChatLuongDto>> GetAll()
        {
        ...
        //[HttpPost]
        //[Route("luu")]
        //public async Task<ActionResult<TLN_NuocMua_ChatLuongDto>> Save(TLN_NuocMua_ChatLuongDto moddel)
        //{
        ...
        [HttpGet]
        [Route("xoa/{Id}")]
        public async Task<ActionResult<TLN_NuocDuoiDat_ChatLuongDto>> Delete(int Id)
        {
